<div class="max-w-md mx-auto my-8">
    ...
    <div class="bg-white p-8 rounded-xl border border-brand-mint shadow-md space-y-6">
        ...
        <div class="text-center">
            <h1 class="text-3xl font-extrabold text-brand-dark tracking-tight">Registro de Organizador</h1>
            <p class="text-brand-emerald text-sm mt-1 font-medium">Crea una cuenta para comenzar a administrar torneos</p>
        </div>
        ...
        <div class="border-t border-slate-100 pt-4 text-center">
            <p class="text-slate-600 text-sm">
                ¿Ya tenés cuenta? 
                <a href="/login" class="text-brand-emerald hover:text-brand-deep font-bold underline transition ml-1">
                    Iniciá sesión acá
                </a>
            </p>
        </div>
